...
with tab1:
    ...
    if 'current_analysis' in st.session_state:
        ...
        # DCA vs 일시불 비교 실행 버튼
        if st.button("🚀 DCA vs 일시불 비교 실행", use_container_width=True, type="primary"):
            # 1년과 5년 데이터 준비
            df_1year = analysis['df'].tail(252)  # 1년 데이터
            df_5year = analysis['df']  # 5년 데이터
